 ...
 // $sql = "Select * from users8201 where username = '$username' AND password = '$password'";
    ...
    if($num == 1){
      while($row = mysqli_fetch_assoc($result)){               //fetch
        if($password == $row['password']){      //hash password verify
          $login = true;
          session_start();
          $_SESSION['login'] = true;
    ...
    <body>
        <div class="container mt-5">
            <div class="row box_container">
                <div class="box1 col-md-6"><img class="col-md-12" src="images/login.jpg" alt=""></div>
                <div class="box2  col-md-6">
                    ...
                    <form action="login.php" method="post" class="row form_container"
                        ...
                        <div class="form-group col-md-12">
                            <button type="submit" name="submit" class="btn btn-primary col-md-12 p-3">Login</button>
                        </div>
